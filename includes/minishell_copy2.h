...
/*   Updated: 2025/12/03 09:34:55 by ssukhija         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef MINISHELL_COPY2_H
# define MINISHELL_COPY2_H
...
t_token				*create_token(t_token_type type, const char *start,
						size_t len);
...
int					process_expanded(char **words, char **dst, int idx,
						t_mode mode);
...
void				set_env(t_env **env_list, const char *key,
						const char *value);
